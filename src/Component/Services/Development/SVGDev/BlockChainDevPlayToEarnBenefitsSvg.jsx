...
export const BlockChainDevPlayToEarnBenefitsSvg = () => {
  return (
    <>
      <svg
        id="blockChainDevPlayToEarnBenefitsSvg"
        viewBox="0 0 485 209"
        fill="none"
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M32.48 0C14.5418 0 0 14.5418 0 32.48V176.204C0 194.142 14.5418 208.684 32.48 208.684H176.204C188.409 208.684 199.041 201.953 204.591 192H37.864C27.998 192 20 184.002 20 174.136V35.864C20 25.998 27.998 18 37.864 18H205.286C199.962 7.32937 188.939 0 176.204 0H32.48Z"
          fill="url(#paint0_linear_2640_4666)"
        />
        <g filter="url(#filter0_d_2640_4666)">
          ...
          <path
            ...
            fill="url(#paint1_linear_2640_4666)"
            mask="url(#path-2-inside-1_2640_4666)"
          />
        </g>
        <defs>
          <filter
            id="filter0_d_2640_4666"
            x="10"
            y="10"
            width="475"
            height="194"
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_2640_4666"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_2640_4666"
              result="shape"
            />
          </filter>
          <linearGradient
            id="paint0_linear_2640_4666"
            x1="144.728"
            y1="-7.92996"
            x2="239.549"
            y2="113.399"
